...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=240&section=header&text=GameZone%20Retro&fontSize=64&fontColor=ffffff&fontAlignY=38&animation=twinkling&desc=Mini%20Desafio%20HTML%20%E2%80%A2%20Loja%20de%20Games%20Retro&descAlignY=62&descSize=20" alt="GameZone Retro - Mini Desafio HTML" />

<a href="https://github.com/DenverCoder1/readme-typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Press+Start+2P&size=14&pause=1200&color=00FF9C&center=true&vCenter=true&width=760&height=50&lines=INSERT+COIN+TO+START...;PLAYER+1+READY!;FEITO+POR+VINYCIUS+LOPES;LET'S+PLAY!" alt="Animação de texto retro" />
</a>
...
![Ajustes](https://img.shields.io/badge/Antes%20de%20subir-2%20ajustes%20pendentes-orange?style=for-the-badge)
...
| 4 | 🖼 Imagem | `<img src="..." width="250" height="120">` | ⚠️ *(caminho local — ver seção abaixo)* |
...
```mermaid
flowchart TD
    DOC(["🌐 index.html"]) --> HEAD["head · title: 'preços'"]
    DOC --> BODY["body"]
    BODY --> H1["h1 · 🎮 GameZone Retro"]
    H1 --> P["p · negrito 'melhor loja' + itálico 'jogos clássicos'"]
    P --> NAV["links: Ver Preços (interno) + Instagram (externo)"]
    NAV --> IMG["img · retro.jpg (250x120)"]
    IMG --> LST["ul · 4 consoles"]
    LST --> TAB["table#tabela-precos · 3 jogos"]
    NAV -. "âncora #tabela-precos" .-> TAB
    NAV -. "target=_blank" .-> WEB(["🌍 instagram.com"])

    classDef doc fill:#8A2BE2,stroke:#fff,color:#fff;
    classDef ext fill:#00c37a,stroke:#fff,color:#fff;
    class DOC doc;
    class WEB ext;
```
...
O `<img>` aponta para um caminho **absoluto do computador do Windows**:
...
```html
<!-- Antes -->
<img src="C:\Users\Dev_1o_Ano\Documents\...\retro.jpg" width="250" height="120">

<!-- Depois -->
<img src="retro.jpg" width="250" height="120" alt="Console e jogos retro">
```
...
<body>
    <h1>🎮GameZone Retro</h1>
        ...
        <br> 
        <br> 
            <img src="C:\Users\Dev_1o_Ano\Documents\Vinycius Lopes Monteiro da Silva\LIMA\HTML_aula1_estruturas básicas\assets 2\retro.jpg" width="250" height="120">
        <br>
...
| 🖼 Imagens | Uso de `<img>` com `width` e `height`, e a importância de caminhos relativos |
